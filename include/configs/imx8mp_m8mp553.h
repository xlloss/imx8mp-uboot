...
#ifndef __IMX8MP_M8MP553_H
#define __IMX8MP_M8MP553_H
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"mmcautodetect=yes\0" \
	"mmcargs=setenv bootargs ${jh_clk} console=${console} root=${mmcroot} ethaddr_eqos=${ethaddr_eqos}\0 " \
